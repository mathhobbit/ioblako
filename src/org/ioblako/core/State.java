 ...
 * Hashtable. The modification allows shared access to this class from 
 * multiple threads.
 *
...
//	private Hashtable<Object,Object> currentState= new Hashtable<Object,Object>();
	private HashMap<String,Object> currentState= new HashMap<String,Object>();
       // private boolean Success=true;
        private  AtomicBoolean lock=new AtomicBoolean(false);
        private AtomicBoolean Success = new AtomicBoolean(true);
        private AtomicBoolean isItDone = new AtomicBoolean(false);
 ...
 */
	...
	public Object get(Object key) throws IllegalMonitorStateException{
            requestLock();
 ...
 * @exception  IllegalMonitorStateException - if the current thread is not the owner of this object's monitor.
 */
	public boolean containsKey(Object key) throws IllegalMonitorStateException{
                requestLock();
 ...
 */
	...
	public Object remove(Object key) throws IllegalMonitorStateException{
		   requestLock();
   ...
   */
	 ...
	 * @param true if the move was successful, otherwise - false
         * @exception  IllegalMonitorStateException - if the current thread is not the owner of this object's monitor.
	 */
